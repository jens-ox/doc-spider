...
const FeaturesHeader = () => (
  <section>
    ...
    <p>
      There are many ways to build a website. If you’re considering blabla, you
    ...
    <ul>
      <li>
        ...
        specific kind of site, usually a, as HTML files from the content you’ve
        added. These files can be cached and served from a CDN.
        <br />
